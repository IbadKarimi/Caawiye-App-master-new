...
class _HospitalDepartments extends State<HospitalDepartments> {
  ...
  Future<List<dynamic>> fetchCategoryData() async {
    var response1 = await http.get(Uri.parse('http://192.168.1.3:8080/Hospital/GetCategoryDataWithHId.php?hospitalId=${widget.hospitalId}'));
    ...
    if (response1.statusCode == 200) {
      ...
      for (var item in data) {
        setState(() {
          isCategoryData=item['imageName'];
          print("Category Image Name is +");
        });
  ...
  Future<List<dynamic>> fetchHospitalData() async {
    var response = await http.get(Uri.parse('http://192.168.102.196:8080/Hospital/GetHospitalData.php'));
  ...
  Future<List<dynamic>> fetchSliderImage() async {
    var response1 = await http.get(Uri.parse('http://192.168.1.3:8080/Hospital/GetSliderImageHId.php?hospitalId=${widget.hospitalId}'));
    // var response = await http.get(Uri.parse('http://192.168.1.6:8080/Hospital/GetCategoryData.php'));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      isHospitalData==null && isCategoryData==null && isSliderData==null? Center(child: CircularProgressIndicator()):
                ...
                HomeCarousel(
                  images: [
                   /* 'https://i.imgur.com/Q7IxnQD.png',
                    ...
                    for (var item in sliderImage)
                      "http://192.168.1.3:8080/Hospital/${item['imageName']}",
                  ],
                ),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: Image.network("http://192.168.1.3:8080/Hospital/" + item, fit: BoxFit.cover,),
